...
Start: ; 0x150
	...
	bit 0, a         ; Check if LCD Display is enabled
...
.LCD_disabled
	...
	res 1, [hl] ; disable LYC=LY interrupt
	ld hl, rIE
...
; gameplay.
	...
	xor %00001000 ; toggle window tile data
	and c
	ld c, a
	ld hl, rSTAT
.waitForHBlank
	...
	and %00000001 ; enable LCD display
	or c
	ld [rLCDC], a
	jp StatIntrDone
...
StatIntrTogglePokedexWindow: ; 0xfea
	...
	xor %00011000 ; toggle window tile data and tile map
	ld c, a
	ld a, [hHBlankSCX]
	ld b, a
	ld hl, rSTAT
